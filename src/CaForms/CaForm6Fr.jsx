...
const CaForm6Fr = () => {
  ...
  const handleSignatureUpload = (e, type) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        if (type === 'licenser') {
          setFormData(prev => ({ ...prev, licenserSignature: file }));
          setPreviewLicenserSignature(reader.result);
        } else {
          setFormData(prev => ({ ...prev, clientSignature: file }));
    ...
    <div className="p-6 max-w-4xl mx-auto bg-white">
      ...
      <div className="flex justify-between mb-8">
        <div className="w-1/2 pr-4">
          ...
          <p className="mt-2">Signature du Licensier</p>
        </div>
        <div className="w-1/2 pl-4">
          ...
          <p className="mt-2">Signature du Client</p>
